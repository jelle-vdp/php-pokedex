...
- Description: a pokedex challenge using PHP for the BeCode webdevelopment course, a variation on [another exercise which I did using only JS](https://github.com/jelle-vdp/pokedex)
